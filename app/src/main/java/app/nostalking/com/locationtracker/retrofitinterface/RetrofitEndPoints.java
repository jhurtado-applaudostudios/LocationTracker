...
public interface RetrofitEndPoints {
    ...
    @POST("/register_users.php")
       public void registerUser(@Field("username") String username, @Field("email") String email, @Field("password") String password, Callback<Response> responce);

    @FormUrlEncoded
    @POST("/check_user_existence.php")
       public void ceckUserExistence(@Field("username") String username, @Field("password") String password, Callback<Response> responce);
